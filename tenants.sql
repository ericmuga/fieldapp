...
--
-- Host: localhost    Database: farmers-automation-tenants-db
-- ------------------------------------------------------
...
INSERT INTO `schema_version` VALUES (1,1,'1','plaform-shared-tenants','SQL','V1__plaform-shared-tenants.sql',302896159,'root','2019-10-30 09:10:11',118,1),(2,2,'2','externalize-connection-properties','SQL','V2__externalize-connection-properties.sql',-862567945,'root','2019-10-30 09:10:11',57,1),(3,3,'3','deadlock-retry-properties','SQL','V3__deadlock-retry-properties.sql',342662266,'root','2019-10-30 09:10:11',53,1),(4,4,'4','introduced oltpId reportId columns and tenants server connection table','SQL','V4__introduced_oltpId_reportId_columns_and_tenants_server_connection_table.sql',417291024,'root','2019-10-30 09:10:11',70,1);
...
INSERT INTO `tenant_server_connections` VALUES (1,'localhost','farmers-db','3306','root','manunited',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1);
...
INSERT INTO `tenants` VALUES (1,'default','Default Demo Tenant','Africa/Nairobi',NULL,NULL,NULL,NULL,1,1);
...
-- Dump completed on 2023-04-28 12:09:27
